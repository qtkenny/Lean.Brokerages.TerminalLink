...
{
    public class TerminalLinkSubscriptionData
    {
        ...
        public TerminalLinkSubscriptionData(CorrelationID correlationId, Symbol symbolName, DateTimeZone exchangeTimeZone)
        {
