...
{
    public static class TerminalLinkNames
    {
        // EVENTS
        ...
        /// </summary>
        public static readonly Name TerminalLinkSendTime = new Name("BLOOMBERG_SEND_TIME_RT");
        ...
        /// </summary>
        public static readonly Name TerminalLinkClosePrice = new Name("BLOOMBERG_CLOSE_PRICE");
        /// <summary>
        /// Value: PX_LAST
        /// </summary>
        ...
        public static readonly Name TradingDateTime = new Name("TRADING_DT_REALTIME");
