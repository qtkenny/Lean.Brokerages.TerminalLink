...
{
    /// <summary>
    ///     Breakdown of a TerminalLink symbol to the Lean equivalent.
    /// </summary>
    /// <see cref="QuantConnect.Symbol" />
    public class TerminalLinkMappingInfo
    {
        /// <summary>
        ...
        /// <summary>
        ///     (Optional) Allows the exact TerminalLink futures / options chain to be specified.
        ///     This will be used over querying TerminalLink itself for the contents of the chain.
        /// </summary>
